...
-- Основной запрос для подсчёта среднего числа учебных заведений, которые окончили сотрудники
SELECT AVG(ins)  -- Выводим среднее количество учебных заведений
FROM (
    ...
    FROM education AS e
    -- Фильтруем сотрудников, которые работают в компаниях из временной таблицы a1
